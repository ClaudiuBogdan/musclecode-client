...
export const ProblemNavigation = ({
  ...
  return (
    <div className="flex flex-col gap-2 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-600 p-0">
      {/* Subtle Progress Bar */}
      ...
      {/* Navigation Controls */}
      <div className="flex items-center justify-between gap-2 pb-2 px-2">
        {/* Previous Button */}
        <motion.div animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
          <Button
            ...
            onClick={onPrev}
            disabled={!hasPrev}
            className="h-8 w-8 bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800"
          >
        ...
        <Button
          ...
          disabled={!hasNext}
          className="flex-1 h-8 px-3 text-left font-normal truncate hover:bg-accent/50 active:scale-[0.98] transition-transform justify-start bg-white dark:bg-gray-900"
        >
  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DropdownMenuContent
        align="start"
        side="bottom"
        className="w-full mb-2 max-w-[32rem] max-h-[70vh] overflow-y-auto rounded-lg shadow-lg border border-gray-200 dark:border-gray-600"
      >
        <div className="p-2">
          <h3 className="text-sm font-semibold text-foreground/80 px-2 mb-2">
            Table of Contents
          </h3>
